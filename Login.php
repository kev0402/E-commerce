        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="d-flex flex-column justify-content-center align-items-center mt-4 w-100">
            <div class="w-50">
                ...
                <div>
                    ...
                    <div class="d-flex justify-content-around mt-5 gap-5">
                        <a class="google btn d-flex align-items-center justify-content-center px-4 py-3 gap-3 rounded-3 fw-semibold" href="https://www.google.com/" id="google">
                    ...
                    <div class=" mt-5">
                        <p class="text-center fw-semibold">Don't have an account? <a href="./Signup.php" class="login"> Sign Up</a></p>
                    </div>
                </div>
            </div>
        </form>
