...
if(isset($_POST['CategoryProduct'])){
    ...
    $CategoryProductID = $_POST['CategoryProduct'];

    $_SESSION['ID'] = $CategoryProductID;
...
$var = mysqli_query($conn, "SELECT * FROM products WHERE Category = '$Category'");
...
<div class="CategoryImage">
    <button class="LogoBtn" name="CategoryProduct" value="<?php echo $row["Product_ID"] ?>">
