        ...
        <div style="display:<?php echo $ModalShow ?> ;" id="DeleteProductConfirmation"> <!-- Delete Confirmation Modal -->
                                 ...
                                 <div  id="confirm">
                                     ...
                                     <div class="modal-body w-100 text-center text-black ">
                                         Are You Sure? <br> You want to delete this Product ID <?php echo $DeleteProductID ?> ?
                                     </div>
                                ...
                                <div class="TopContainer">
                                    ...
                                    <div class="TopProductList">
                                        ...
                                        ?>
                                            ...
                                            <img src="./Image/Dashboard/AddProduct Image/<?php echo $row["Product_Image"] ?>" alt="" class="TopProductIMG">

                                            <div class="TopProductDetail">

                                            <label for=""><?php echo $row["Product_Name"] ?></label>

                                            <label for="">1 sold</label>

                                            </div>

                                            <div class="Instock">

                                            <div style="background:<?php echo $InStockColor ?> ;" class="StockAlert"></div>

                                            <label for=""><?php echo $InStock ?></label>
                                    ...
                                    <div class="ListOfProducts">
                                        ...
                                        <div class="ListContainer">
                                            ...
                                            <div class="Command">
                                                ...
                                                <button class="EditBtn" name="DeleteProductID" value="<?php echo $row["Product_ID"] ?>" data-bs-target="#DeleteProductConfirmation" data-bs-toggle="modal">
                                                <img  src="./Image/Dashboard/AddProduct Image/trash.png" alt="" id="DeleteProduct" ></button>
